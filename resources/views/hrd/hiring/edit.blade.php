                ...
                <div class="bg-white p-6 md:p-8 rounded-3xl border border-slate-200/80 shadow-sm space-y-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2" x-show="category === 'Asisten Keperawatan'" x-transition>
                            ...
                            <input type="text" name="req_placement_choices_value" :disabled="placementChoicesStatus === 'nonaktif'" value="{{ old('req_placement_choices_value', $placementChoicesValue) }}" placeholder="Pisahkan wilayah dengan koma, contoh: Cakung, Lebak Bulus" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs focus:outline-none focus:border-blue-500 transition-all" :class="placementChoicesStatus === 'nonaktif' ? 'bg-slate-50 text-slate-400 border-slate-100' : 'bg-white text-slate-800'">
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div x-show="category !== 'Asisten Keperawatan' && placementStatus === 'nonaktif'" x-transition>
                                ...
                                <div class="grid grid-cols-2 gap-3 mt-2">
                                    <select id="location-province" class="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs" :required="category !== 'Asisten Keperawatan' && placementStatus === 'nonaktif'">
                                        <option value="">Pilih Provinsi</option>
                                    </select>
                                    <select id="location-city" name="location_city"
                                        class="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs" :required="category !== 'Asisten Keperawatan' && placementStatus === 'nonaktif'">
